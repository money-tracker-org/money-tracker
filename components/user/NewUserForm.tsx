...
export default function CreateNewUser() {
    ...
    const submitUser = () => {
        const validationResult = { firstName: inputForm.firstName !== "", lastName: inputForm.lastName !== "" }
        ...
        <form onSubmit={e => e.preventDefault()}>
            <div>
                <input
                    ...
                    aria-invalid={fieldsValid.firstName === true ? undefined : true}
                    required
                />
            </div>
            <div>
                <input
                    ...
                    onChange={handleKeyPress}
                    aria-invalid={fieldsValid.lastName === true ? undefined : true}
                    required
                />
            </div>
            <div>
                <button
                    type="submit"
                    onClick={submitUser}
                    aria-busy={loading ? "true" : "false"}>Create New User </button>
            </div>
        </form>
    );
}
